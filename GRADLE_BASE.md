...
На основе настроенных метаданных управления зависимостями плагин будет управлять версиями прямых и транзитивных зависимостей вашего проекта и будет учитывать любые исключения, объявленные в pom`s зависимостей вашего проекта
